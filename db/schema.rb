...
ActiveRecord::Schema.define(version: 2025_09_27_022311) do
  ...
  create_table "grave_genres", force: :cascade do |t|
    t.integer "grave_id", null: false
    t.integer "genre_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["genre_id"], name: "index_grave_genres_on_genre_id"
    t.index ["grave_id"], name: "index_grave_genres_on_grave_id"
  end
  ...
  add_foreign_key "grave_genres", "graves"
